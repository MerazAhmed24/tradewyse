...
public class TipsAfterMacDAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    TipsAdapter.CallTipDetailEventListener listener;
    private ArrayList<TipsSection> tipCrossoverResponseAfterMacD = new ArrayList<>();
    private int filter;
    private String selectedScreen = "";

    public TipsAfterMacDAdapter(ArrayList<TipsSection> tipsList, StocksAdapter stocksAdapter, Context context,
                                LinearLayoutManager linearLayoutManager, TipsAdapter.CallTipDetailEventListener listener,
                                ArrayList<TipsSection> tipCrossoverResponseAfterMacD,
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder tipsViewHolder, @SuppressLint("RecyclerView") int i) {
        TipsSection tipsSection = null;
        if (tipsViewHolder instanceof TipsViewHolderHorizontal) {
            tipsSection = tipsList.get(i);
            ...
            viewHolder.imgComment.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                   listener.onTipDetailCallEvent(context, tipResponse, true, i, true);
                }
            });
            ...
            viewHolder.imgMedia.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    listener.onTipDetailCallEvent(context, tipResponse, false, i, true);
                }
            });
    ...
    public void setTipsDetailClick(LinearLayout tipRootLayout, final TipResponse tips, int position) {
        tipRootLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                listener.onTipDetailCallEvent(context, tips, false, position, true);
            }
        });
    }
    ...
    public int getItemViewType(int position) {
        if (linearLayoutManager.getOrientation() == LinearLayoutManager.HORIZONTAL) {
            if (tipsList.get(position).getTipsType() == MENTOR_TIP) {
                return 1;
    ...
    public ArrayList<TipsSection> sortAITip() {
        ...
        ArrayList<TipsSection> tipsSections = getTipsFromAdapter(TipsAfterMacDAdapter.AI_TRADE_TIP);
    ...
    public static class TipsViewHolderHorizontal extends RecyclerView.ViewHolder {
        ...
        private LinearLayout layoutRootHorizontal;

        public TipsViewHolderHorizontal(View view) {
            super(view);
            layoutRootHorizontal = view.findViewById(R.id.layoutRootHorizontal);
            ...
            layoutRootHorizontal.setPadding(10,0,10,0);
        }
    }
        ...
        if (tipsList != null) {
            for (int i = 0; i < tipsList.size(); i++) {
                if (tipType == AI_TRADE_TIP) {
                    if (tipsList.get(i).getTipsType() == TipsAfterMacDAdapter.AI_TRADE_TIP || tipsList.get(i).getTipsType() == 2) {
    ...
    private void setChangeValue(Double createTipPrice, Double stockPrice, TextView txtChangeValue, TextView txtCurrentPrice) {
        ...
        if (stockPrice == 0) {
            ...
            /*txtChangeValue.setText(StringHelper.getAmount(Math.abs(change), "--"));*/
        }
    ...
    private void showMoreDialog(TipResponse tipResponse, int position, View viewForSS) {
        try {
            ...
            txtTweetTip.setOnClickListener((view) -> {
                ...
                //requestStoragePermission(username, tipResponse.getTip(), context);
