...
public class BuyStock implements Parcelable {
    ...
    public static final Creator<BuyStock> CREATOR = new Creator<BuyStock>() {
        @Override
        public BuyStock createFromParcel(Parcel in) {
            return new BuyStock(in);
        }

        @Override
        public BuyStock[] newArray(int size) {
            return new BuyStock[size];
        }
    };
